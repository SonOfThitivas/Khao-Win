                ...
                <div className='w-full flex justify-center'>
                    <div className=' md:w-[768px] w-full m-5 border-8 border-black rounded-2xl bg-orange-300'>
                        <div className='flex flex-col'>
                            ...
                            <textarea
                            ref={messageRef}
                            placeholder="Fill in the details of the complaint."
                            rows="10"
                            cols="30"
                        ...
                        <div className='flex justify-center gap-2 mb-2'>
                            <button type="button" className='bg-green-300 active:bg-green-500 sm:w-1/3 w-1/3 text-2xl p-2 rounded-2xl border-2 border-black' onClick={sendEmail} aria-label="Send email">Send</button>
                            <button type="button" id="reset-btn" className='bg-yellow-300 active:bg-yellow-500 sm:w-1/3 w-1/3 text-2xl p-2 rounded-2xl border-2 border-black' onClick={resetForm} aria-label="Reset form">Reset</button>
                        </div>
                    </div>
                </div>
            </div>
