...
function CardOnMobileTH({data}){
    return(
        <>
            ...
            />
            <div className='mb-1 w-full h-full justify-center content-center'>
                <p className='text-3xl text-center'>{data.nameTH}</p>
                <div className='mb-1 flex flex-col'>
                    <div className='w-full flex justify-center'>
                        <p className='px-1'>ตำแหน่ง:</p>
                        <p className='px-1'>{data.positionTH}</p>
                    </div>
                    <div className='w-full flex justify-center flex-wrap'>
                        <p className='px-1 justify-end flex'><MdEmail size={20}/>อีเมล:</p>
                        <p className='px-1'>{data.email}</p>
                    </div>
                </div>
            </div>
